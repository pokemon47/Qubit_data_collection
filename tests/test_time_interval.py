...
class TestAddInterval(unittest.TestCase):
    ...
    def test_multiple_merging(self):
        ...
        add_interval(intervals, "05-01-2024", "15-06-2024")
        self.assertEqual(intervals, expected)
